...
export function Metrics() {
  ...
  const chartData = useMemo(() => parseMetricFamilies(metrics.data), [metrics.data]);
  ...
  return (
    <div>
        ...
        action={
          <>
            <Button asChild variant="outline">
              <a href={`${config.apiUrl}/metrics`} target="_blank" rel="noreferrer">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <MetricCard title="Metrics Endpoint" value={metrics.isSuccess ? 'Available' : 'Checking'} />
      ...
      <div className="mt-6 grid gap-4 xl:grid-cols-[minmax(0,1fr)_minmax(360px,480px)]">
        ...
        <div className="rounded-lg border border-slate-200 bg-white p-4">
          <h2 className="text-sm font-semibold text-slate-950">Metric family density</h2>
